...
public interface JobApi {
    ...
    @ApiOperation(value = "", nickname = "jobPost", notes = "", authorizations = {
        @Authorization(value = "revwork_security_schema")    }, tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "The job was posted successfully.") })
    @RequestMapping(value = "/job",
        consumes = { "application/json" },
        method = RequestMethod.POST)
    ResponseEntity<Void> jobPost(@ApiParam(value = "" ,required=true )  @Valid @RequestBody Availablejob body
);
